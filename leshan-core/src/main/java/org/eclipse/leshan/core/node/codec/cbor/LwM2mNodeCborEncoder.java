    ...
    private static class InternalEncoder implements LwM2mNodeVisitor {
        ...
        private CBORObject getCborValue(Type expectedType, Object val) {
            ...
            case TIME:
                ...
                // TODO we prefer to encode using timestamp but there is maybe a bug in CBOR-java
                // number of seconds since 1970/1/1
                // long time = ((Date) val).getTime();
                // cbor = CBORObject.FromObjectAndTag(time, 1);

                // using this could works but encode the date as string which sounds a bit less straightforward.
